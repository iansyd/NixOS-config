{
  programs.plasma = {
    ...
    shortcuts = {
      "ActivityManager"."switch-to-activity-6341e54b-53a0-4021-ad7d-00c5bfe53165" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,3,11,17,4,18.809";
      "dolphinrc"."IconsMode"."IconSize" = 16;
      "dolphinrc"."IconsMode"."PreviewSize" = 22;
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "dolphinrc"."PreviewSettings"."Plugins" = "exrthumbnail,ebookthumbnail,comicbookthumbnail,kraorathumbnail,opendocumentthumbnail,appimagethumbnail,directorythumbnail,jpegthumbnail,audiothumbnail,windowsimagethumbnail,djvuthumbnail,windowsexethumbnail,imagethumbnail,svgthumbnail,cursorthumbnail,fontthumbnail,ffmpegthumbs,mobithumbnail,gsthumbnail,blenderthumbnail,rawthumbnail";
      "kactivitymanagerdrc"."activities"."6341e54b-53a0-4021-ad7d-00c5bfe53165" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "6341e54b-53a0-4021-ad7d-00c5bfe53165";
      ...
      "kwinrc"."Desktops"."Id_1" = "8fad8290-7197-4a71-ae47-73d8b7fe58d0";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/1b2d53c5-546f-5342-9331-3d50e51cf70f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/47e0019d-06bb-57e4-92e6-d6fc338d111b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/965a05d3-13f2-5fdf-a64e-5260a785abd6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/a8007658-1727-5b8f-b516-121430cf4966"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_GB.UTF-8";
      "plasma-localerc"."Formats"."LC_ADDRESS" = "en_NZ.UTF-8";
      "plasma-localerc"."Formats"."LC_MEASUREMENT" = "en_NZ.UTF-8";
      "plasma-localerc"."Formats"."LC_MONETARY" = "en_NZ.UTF-8";
      "plasma-localerc"."Formats"."LC_NAME" = "en_NZ.UTF-8";
      "plasma-localerc"."Formats"."LC_PAPER" = "en_NZ.UTF-8";
      "plasma-localerc"."Formats"."LC_TELEPHONE" = "en_NZ.UTF-8";
      "plasmanotifyrc"."Applications/brave-browser"."Seen" = true;
    };
    dataFile = {
      "dolphin/view_properties/global/.directory"."Dolphin"."ViewMode" = 1;
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/ian/dotfiles/system/wm/kde.nix";
      "kate/anonymous.katesession"."Document 1"."URL" = "file:///home/ian/dotfiles/home/ian/modules/programs.nix";
      "kate/anonymous.katesession"."Document 2"."URL" = "file:///home/ian/dotfiles/flake.nix";
      "kate/anonymous.katesession"."Document 3"."URL" = "file:///home/ian/dotfiles/system/general/networking.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 1032;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 1032;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 582;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,1032,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 914;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorColumn" = 24;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorLine" = 207;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."ScrollLine" = 181;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/flake.nix"."CursorColumn" = 13;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/flake.nix"."CursorLine" = 140;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/flake.nix"."ScrollLine" = 109;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/home\\/ian\\/modules\\/terminal\\/fish.nix"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/home\\/ian\\/modules\\/terminal\\/fish.nix"."CursorLine" = 59;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/home\\/ian\\/modules\\/terminal\\/kitty.nix"."CursorColumn" = 27;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/home\\/ian\\/modules\\/terminal\\/kitty.nix"."CursorLine" = 143;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/home\\/ian\\/modules\\/terminal\\/kitty.nix"."ScrollLine" = 104;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/home\\/ian\\/modules\\/z_config.nix"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/home\\/ian\\/modules\\/z_config.nix"."CursorLine" = 23;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/system\\/wm\\/pipewire.nix"."CursorColumn" = 10;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/ian\\/dotfiles\\/system\\/wm\\/pipewire.nix"."CursorLine" = 9;

{ inputs, config, lib, pkgs, userSettings, systemSettings, pkgs-nwg-dock-hyprland, stylix, ... }: let
...
in
{
  imports = [
    ...
    ../../terminal/kitty.nix
    (import ../../dmenu-scripts/networkmanager-dmenu.nix {
...
/*  (if (systemSettings.hostType <> "server") then

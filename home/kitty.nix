...
#         #modify_font = "cell_width 90%";
        ...
        #: syntax>.
        #font_family is set by the option programs.kitty.font.name
        bold_font = "auto";
        italic_font = "auto";
        bold_italic_font = "auto";
        #font size is set by the option programs.kitty.font.size
        ...
        #: supported by the OS. Note that it only sets the background color's opacity in
...
###############################################################
# Full text of default kitty.conf follows:
